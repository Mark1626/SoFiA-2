...
//                                                                      //
// SoFiA 2.5.0 (statistics_SFX.c) - Source Finding Application          //
...
DATA_T kin_maj_axis_SFX(const DATA_T *centroidX, const DATA_T *centroidY, const DATA_T *sum, const size_t size, const size_t first, const size_t last)
{
	...
	const DATA_T difference = fabs(atan2(sin(fullAngle) * cos(pa) - cos(fullAngle) * sin(pa), cos(fullAngle) * cos(pa) + sin(fullAngle) * sin(pa)));
